...
Advent of code 2015 problems solved using [Python](https://www.python.org/).

## Installation and setup

- Install [Python](https://www.python.org/downloads)
- (Optional) Create a [virtualenv](https://virtualenv.pypa.io/en/latest/user_guide.html)
- Install the project and its dependencies by running `pip install -e .` in this folder.
